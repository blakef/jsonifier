...
module.exports = class JSONifier {
    ...
    constructor(state, ops) {
        ...
        this._state = state instanceof JSONifier ? _.cloneDeep(state._state) : {};

        this._current = _.isUndefined(this.options.namespace) ? this._state : createObject(this._state, this.options.namespace, {});
    }
